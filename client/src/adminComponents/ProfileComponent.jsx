...
export default function ProfileComponent() {
  ...
  return (
    <div id="mainForm" className="mt-10 w-full">
      ...
      <form onSubmit={handleSubmit} className="hidden flexCenter mx-auto w-full flex-col max-w-[800px] shadow-lg p-5 rounded-md border border my-10 bg-gray-100 bg-opacity-60 flex-col gap-7">
        {success && <p className="text-white bg-green-500 p-4 rounded-md w-full font-bold text-xl text-center mt-5">Profile Uploaded Successfully</p> }
