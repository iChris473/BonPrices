    ...
    const newUser = {
     ...
     try {
      ...
      if(cart.length == 0){
        ...
        setSubmit(false)
        window.location.href = 'https://api.whatsapp.com/send?phone=+234 913 453 5917&text=Hello%2C%20I%20just%20placed%20an%20order%20of%20Naked%20Wolf%20Black%20Footware%2C%0AIm%20ready%20to%20pay%205000%20right%20now%20to%20complete%20the%20Order%20%0AMy%20email%20is%20wu%40gmail.com%20and%20my%20phone%20number%20is%20090345333'
        // navigate("/payment")
      } else {
